...
class CkPrng
{
    ...
    public function get_PrngName($str)
    {
        CkPrng_get_PrngName($this->_cPtr, $str);
    }

    public function prngName()
    {
        return CkPrng_prngName($this->_cPtr);
    }

    public function put_PrngName($newVal)
    {
