...
class CkHtmlToXml
{
    ...
    public function get_DropCustomTags()
    {
        return CkHtmlToXml_get_DropCustomTags($this->_cPtr);
    }

    public function put_DropCustomTags($newVal)
    {
        CkHtmlToXml_put_DropCustomTags($this->_cPtr, $newVal);
    }

    public function get_Html($str)
    {
    ...
    public function put_Html($newVal)
    {
    ...
    public function get_Nbsp()
    {
        return CkHtmlToXml_get_Nbsp($this->_cPtr);
    }

    public function put_Nbsp($newVal)
    {
    ...
    public function SetHtmlBd($bd)
    {
        return CkHtmlToXml_SetHtmlBd($this->_cPtr, $bd);
    }

    public function SetHtmlBytes($inData)
    {
    ...
    public function ToXmlSb($sb)
    {
        return CkHtmlToXml_ToXmlSb($this->_cPtr, $sb);
    }

    public function UndropTagType($tagName)
    {
        CkHtmlToXml_UndropTagType($this->_cPtr, $tagName);
    }

    public function UndropTextFormattingTags()
    {
    ...
    public function WriteFile($path, $fileData)
    {
