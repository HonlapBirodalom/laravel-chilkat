...
class CkHttp
{
    ...
    public function get_Accept($str)
    {
        CkHttp_get_Accept($this->_cPtr, $str);
    }

    public function ck_accept()
    {
        return CkHttp_ck_accept($this->_cPtr);
    }

    public function put_Accept($newVal)
    {
        CkHttp_put_Accept($this->_cPtr, $newVal);
    }

    public function get_AcceptCharset($str)
    {
    ...
    public function put_AcceptCharset($newVal)
    {
        CkHttp_put_AcceptCharset($this->_cPtr, $newVal);
    }

    public function get_AcceptLanguage($str)
    {
    ...
    public function put_AcceptLanguage($newVal)
    {
        CkHttp_put_AcceptLanguage($this->_cPtr, $newVal);
    }

    public function get_AllowGzip()
    {
        return CkHttp_get_AllowGzip($this->_cPtr);
    }

    public function put_AllowGzip($newVal)
    {
    ...
    public function get_AuthSignature($str)
    {
    ...
    public function put_AuthSignature($newVal)
    {
        CkHttp_put_AuthSignature($this->_cPtr, $newVal);
    }

    public function get_AuthToken($str)
    {
    ...
    public function put_AwsRegion($newVal)
    {
        CkHttp_put_AwsRegion($this->_cPtr, $newVal);
    }

    public function get_AwsSecretKey($str)
    {
        CkHttp_get_AwsSecretKey($this->_cPtr, $str);
    }

    public function awsSecretKey()
    {
        return CkHttp_awsSecretKey($this->_cPtr);
    }

    public function put_AwsSecretKey($newVal)
    {
        CkHttp_put_AwsSecretKey($this->_cPtr, $newVal);
    }

    public function get_AwsSignatureVersion()
    {
        return CkHttp_get_AwsSignatureVersion($this->_cPtr);
    }

    public function put_AwsSignatureVersion($newVal)
    {
        CkHttp_put_AwsSignatureVersion($this->_cPtr, $newVal);
    }

    public function get_AwsSubResources($str)
    {
        CkHttp_get_AwsSubResources($this->_cPtr, $str);
    }

    public function awsSubResources()
    {
        return CkHttp_awsSubResources($this->_cPtr);
    }

    public function put_AwsSubResources($newVal)
    {
    ...
    public function get_BasicAuth()
    {
        return CkHttp_get_BasicAuth($this->_cPtr);
    }

    public function put_BasicAuth($newVal)
    {
    ...
    public function get_Connection($str)
    {
    ...
    public function put_Connection($newVal)
    {
    ...
    public function get_CookieDir($str)
    {
        CkHttp_get_CookieDir($this->_cPtr, $str);
    }

    public function cookieDir()
    {
        return CkHttp_cookieDir($this->_cPtr);
    }

    public function put_CookieDir($newVal)
    {
    ...
    public function get_DefaultFreshPeriod()
    {
        return CkHttp_get_DefaultFreshPeriod($this->_cPtr);
    }

    public function put_DefaultFreshPeriod($newVal)
    {
        CkHttp_put_DefaultFreshPeriod($this->_cPtr, $newVal);
    }

    public function get_DigestAuth()
    {
        return CkHttp_get_DigestAuth($this->_cPtr);
    }

    public function put_DigestAuth($newVal)
    {
    ...
    public function get_FollowRedirects()
    {
        return CkHttp_get_FollowRedirects($this->_cPtr);
    }

    public function put_FollowRedirects($newVal)
    {
        CkHttp_put_FollowRedirects($this->_cPtr, $newVal);
    }

    public function get_FreshnessAlgorithm()
    {
        return CkHttp_get_FreshnessAlgorithm($this->_cPtr);
    }

    public function put_FreshnessAlgorithm($newVal)
    {
    ...
    public function get_KeepResponseBody()
    {
        return CkHttp_get_KeepResponseBody($this->_cPtr);
    }

    public function put_KeepResponseBody($newVal)
    {
        CkHttp_put_KeepResponseBody($this->_cPtr, $newVal);
    }

    public function get_LastContentType($str)
    {
        CkHttp_get_LastContentType($this->_cPtr, $str);
    }

    public function lastContentType()
    {
    ...
    public function get_LastHeader($str)
    {
    ...
    public function get_LastModDate($str)
    {
        CkHttp_get_LastModDate($this->_cPtr, $str);
    }

    public function lastModDate()
    {
        return CkHttp_lastModDate($this->_cPtr);
    }

    public function get_LastResponseBody($str)
    {
    ...
    public function get_LastResponseHeader($str)
    {
        CkHttp_get_LastResponseHeader($this->_cPtr, $str);
    }

    public function lastResponseHeader()
    {
    ...
    public function get_LastStatusText($str)
    {
    ...
    public function get_LMFactor()
    {
        return CkHttp_get_LMFactor($this->_cPtr);
    }

    public function put_LMFactor($newVal)
    {
    ...
    public function get_LoginDomain($str)
    {
        CkHttp_get_LoginDomain($this->_cPtr, $str);
    }

    public function loginDomain()
    {
        return CkHttp_loginDomain($this->_cPtr);
    }

    public function put_LoginDomain($newVal)
    {
        CkHttp_put_LoginDomain($this->_cPtr, $newVal);
    }

    public function get_MaxConnections()
    {
        return CkHttp_get_MaxConnections($this->_cPtr);
    }

    public function put_MaxConnections($newVal)
    {
        CkHttp_put_MaxConnections($this->_cPtr, $newVal);
    }

    public function get_MaxFreshPeriod()
    {
        return CkHttp_get_MaxFreshPeriod($this->_cPtr);
    }

    public function put_MaxFreshPeriod($newVal)
    {
    ...
    public function get_OAuth1()
    {
        return CkHttp_get_OAuth1($this->_cPtr);
    }

    public function put_OAuth1($newVal)
    {
        CkHttp_put_OAuth1($this->_cPtr, $newVal);
    }

    public function get_OAuthBodyHash()
    {
        return CkHttp_get_OAuthBodyHash($this->_cPtr);
    }

    public function put_OAuthBodyHash($newVal)
    {
        CkHttp_put_OAuthBodyHash($this->_cPtr, $newVal);
    }

    public function get_OAuthCallback($str)
    {
    ...
    public function put_OAuthCallback($newVal)
    {
        CkHttp_put_OAuthCallback($this->_cPtr, $newVal);
    }

    public function get_OAuthConsumerKey($str)
    {
    ...
    public function put_OAuthToken($newVal)
    {
        CkHttp_put_OAuthToken($this->_cPtr, $newVal);
    }

    public function get_OAuthTokenSecret($str)
    {
    ...
    public function put_OAuthTokenSecret($newVal)
    {
        CkHttp_put_OAuthTokenSecret($this->_cPtr, $newVal);
    }

    public function get_OAuthVerifier($str)
    {
        CkHttp_get_OAuthVerifier($this->_cPtr, $str);
    }

    public function oAuthVerifier()
    {
        return CkHttp_oAuthVerifier($this->_cPtr);
    }

    public function put_OAuthVerifier($newVal)
    {
    ...
    public function get_ProxyAuthMethod($str)
    {
        CkHttp_get_ProxyAuthMethod($this->_cPtr, $str);
    }

    public function proxyAuthMethod()
    {
        return CkHttp_proxyAuthMethod($this->_cPtr);
    }

    public function put_ProxyAuthMethod($newVal)
    {
        CkHttp_put_ProxyAuthMethod($this->_cPtr, $newVal);
    }

    public function get_ProxyDirectTls()
    {
        return CkHttp_get_ProxyDirectTls($this->_cPtr);
    }

    public function put_ProxyDirectTls($newVal)
    {
    ...
    public function get_ProxyLoginDomain($str)
    {
        CkHttp_get_ProxyLoginDomain($this->_cPtr, $str);
    }

    public function proxyLoginDomain()
    {
        return CkHttp_proxyLoginDomain($this->_cPtr);
    }

    public function put_ProxyLoginDomain($newVal)
    {
    ...
    public function get_ReceivedCertReq()
    {
        return CkHttp_get_ReceivedCertReq($this->_cPtr);
    }

    public function get_RedirectVerb($str)
    {
        CkHttp_get_RedirectVerb($this->_cPtr, $str);
    }

    public function redirectVerb()
    {
        return CkHttp_redirectVerb($this->_cPtr);
    }

    public function put_RedirectVerb($newVal)
    {
        CkHttp_put_RedirectVerb($this->_cPtr, $newVal);
    }

    public function get_Referer($str)
    {
    ...
    public function put_Referer($newVal)
    {
        CkHttp_put_Referer($this->_cPtr, $newVal);
    }

    public function get_RequiredContentType($str)
    {
        CkHttp_get_RequiredContentType($this->_cPtr, $str);
    }

    public function requiredContentType()
    {
        return CkHttp_requiredContentType($this->_cPtr);
    }

    public function put_RequiredContentType($newVal)
    {
    ...
    public function get_S3Ssl()
    {
        return CkHttp_get_S3Ssl($this->_cPtr);
    }

    public function put_S3Ssl($newVal)
    {
        CkHttp_put_S3Ssl($this->_cPtr, $newVal);
    }

    public function get_SaveCookies()
    {
        return CkHttp_get_SaveCookies($this->_cPtr);
    }

    public function put_SaveCookies($newVal)
    {
    ...
    public function get_SendCookies()
    {
        return CkHttp_get_SendCookies($this->_cPtr);
    }

    public function put_SendCookies($newVal)
    {
        CkHttp_put_SendCookies($this->_cPtr, $newVal);
    }

    public function get_SessionLogFilename($str)
    {
        CkHttp_get_SessionLogFilename($this->_cPtr, $str);
    }

    public function sessionLogFilename()
    {
        return CkHttp_sessionLogFilename($this->_cPtr);
    }

    public function put_SessionLogFilename($newVal)
    {
    ...
    public function get_StreamResponseBodyPath($str)
    {
        CkHttp_get_StreamResponseBodyPath($this->_cPtr, $str);
    }

    public function streamResponseBodyPath()
    {
        return CkHttp_streamResponseBodyPath($this->_cPtr);
    }

    public function put_StreamResponseBodyPath($newVal)
    {
    ...
    public function ClearInMemoryCookies()
    {
        CkHttp_ClearInMemoryCookies($this->_cPtr);
    }

    public function ClearUrlVars()
    {
    ...
    public function CloseAllConnectionsAsync()
    {
    ...
    public function CreateOcspRequest($requestDetails, $ocspRequest)
    {
        return CkHttp_CreateOcspRequest($this->_cPtr, $requestDetails, $ocspRequest);
    }

    public function CreateTimestampRequest($hashAlg, $hashVal, $reqPolicyOid, $addNonce, $reqTsaCert, $timestampToken)
    {
    ...
    public function Download($url, $localFilePath)
    {
        return CkHttp_Download($this->_cPtr, $url, $localFilePath);
    }

    public function DownloadAsync($url, $localFilePath)
    {
    ...
    public function DownloadAppend($url, $filename)
    {
        return CkHttp_DownloadAppend($this->_cPtr, $url, $filename);
    }

    public function DownloadAppendAsync($url, $filename)
    {
    ...
    public function DownloadBd($url, $binData)
    {
        return CkHttp_DownloadBd($this->_cPtr, $url, $binData);
    }

    public function DownloadBdAsync($url, $binData)
    {
    ...
    public function downloadHash($url, $hashAlgorithm, $encoding)
    {
        return CkHttp_downloadHash($this->_cPtr, $url, $hashAlgorithm, $encoding);
    }

    public function DownloadHashAsync($url, $hashAlgorithm, $encoding)
    {
    ...
    public function DownloadSb($url, $charset, $sb)
    {
        return CkHttp_DownloadSb($this->_cPtr, $url, $charset, $sb);
    }

    public function DownloadSbAsync($url, $charset, $sb)
    {
    ...
    public function extractMetaRefreshUrl($htmlContent)
    {
        return CkHttp_extractMetaRefreshUrl($this->_cPtr, $htmlContent);
    }

    public function g_SvcOauthAccessToken($iss, $scope, $subEmail, $numSec, $cert)
    {
        return CkHttp_g_SvcOauthAccessToken($this->_cPtr, $iss, $scope, $subEmail, $numSec, $cert);
    }

    public function G_SvcOauthAccessTokenAsync($iss, $scope, $subEmail, $numSec, $cert)
    {
    ...
    public function g_SvcOauthAccessToken2($claimParams, $numSec, $cert)
    {
        return CkHttp_g_SvcOauthAccessToken2($this->_cPtr, $claimParams, $numSec, $cert);
    }

    public function G_SvcOauthAccessToken2Async($claimParams, $numSec, $cert)
    {
    ...
    public function getCookieXml($domain)
    {
        return CkHttp_getCookieXml($this->_cPtr, $domain);
    }

    public function cookieXml($domain)
    {
    ...
    public function GetHeadAsync($url)
    {
    ...
    public function GetServerSslCert($domain, $port)
    {
    ...
    public function GetServerSslCertAsync($domain, $port)
    {
    ...
    public function OcspCheck($domain, $port)
    {
        return CkHttp_OcspCheck($this->_cPtr, $domain, $port);
    }

    public function OcspCheckAsync($domain, $port)
    {
    ...
    public function ParseOcspReply($ocspReply, $replyData)
    {
        return CkHttp_ParseOcspReply($this->_cPtr, $ocspReply, $replyData);
    }

    public function PBinary($verb, $url, $byteData, $contentType, $md5, $gzip)
    {
    ...
    public function PBinaryAsync($verb, $url, $byteData, $contentType, $md5, $gzip)
    {
    ...
    public function PBinaryBd($verb, $url, $data, $contentType, $md5, $gzip)
    {
    ...
    public function PBinaryBdAsync($verb, $url, $data, $contentType, $md5, $gzip)
    {
    ...
    public function PFile($verb, $url, $localFilePath, $contentType, $md5, $gzip)
    {
    ...
    public function PFileAsync($verb, $url, $localFilePath, $contentType, $md5, $gzip)
    {
    ...
    public function postBinary($url, $byteData, $contentType, $md5, $gzip)
    {
        return CkHttp_postBinary($this->_cPtr, $url, $byteData, $contentType, $md5, $gzip);
    }

    public function PostBinaryAsync($url, $byteData, $contentType, $md5, $gzip)
    {
    ...
    public function PostJson($url, $jsonText)
    {
    ...
    public function PostJsonAsync($url, $jsonText)
    {
    ...
    public function PostJson2($url, $contentType, $jsonText)
    {
    ...
    public function PostJson2Async($url, $contentType, $jsonText)
    {
    ...
    public function PostJson3($url, $contentType, $json)
    {
    ...
    public function PostJson3Async($url, $contentType, $json)
    {
    ...
    public function PostUrlEncoded($url, $req)
    {
    ...
    public function PostUrlEncodedAsync($url, $req)
    {
    ...
    public function PostXml($endpointUrl, $xmlContent, $xmlCharset)
    {
    ...
    public function PostXmlAsync($endpointUrl, $xmlContent, $xmlCharset)
    {
    ...
    public function PText($verb, $url, $textData, $charset, $contentType, $md5, $gzip)
    {
    ...
    public function PTextAsync($verb, $url, $textData, $charset, $contentType, $md5, $gzip)
    {
    ...
    public function PTextSb($verb, $url, $textData, $charset, $contentType, $md5, $gzip)
    {
    ...
    public function PTextSbAsync($verb, $url, $textData, $charset, $contentType, $md5, $gzip)
    {
    ...
    public function putBinary($url, $byteData, $contentType, $md5, $gzip)
    {
        return CkHttp_putBinary($this->_cPtr, $url, $byteData, $contentType, $md5, $gzip);
    }

    public function PutBinaryAsync($url, $byteData, $contentType, $md5, $gzip)
    {
    ...
    public function putText($url, $textData, $charset, $contentType, $md5, $gzip)
    {
        return CkHttp_putText($this->_cPtr, $url, $textData, $charset, $contentType, $md5, $gzip);
    }

    public function PutTextAsync($url, $textData, $charset, $contentType, $md5, $gzip)
    {
    ...
    public function quickDeleteStr($url)
    {
        return CkHttp_quickDeleteStr($this->_cPtr, $url);
    }

    public function QuickDeleteStrAsync($url)
    {
    ...
    public function QuickGet($url, $outData)
    {
        return CkHttp_QuickGet($this->_cPtr, $url, $outData);
    }

    public function QuickGetAsync($url)
    {
    ...
    public function QuickGetBd($url, $binData)
    {
        return CkHttp_QuickGetBd($this->_cPtr, $url, $binData);
    }

    public function QuickGetBdAsync($url, $binData)
    {
    ...
    public function QuickGetObj($url)
    {
    ...
    public function QuickGetObjAsync($url)
    {
    ...
    public function QuickGetSb($url, $sbContent)
    {
        return CkHttp_QuickGetSb($this->_cPtr, $url, $sbContent);
    }

    public function QuickGetSbAsync($url, $sbContent)
    {
    ...
    public function quickGetStr($url)
    {
        return CkHttp_quickGetStr($this->_cPtr, $url);
    }

    public function QuickGetStrAsync($url)
    {
    ...
    public function quickPutStr($url)
    {
        return CkHttp_quickPutStr($this->_cPtr, $url);
    }

    public function QuickPutStrAsync($url)
    {
    ...
    public function QuickRequest($verb, $url)
    {
    ...
    public function QuickRequestAsync($verb, $url)
    {
    ...
    public function QuickRequestParams($verb, $url, $json)
    {
    ...
    public function QuickRequestParamsAsync($verb, $url, $json)
    {
    ...
    public function ResumeDownload($url, $targetFilename)
    {
        return CkHttp_ResumeDownload($this->_cPtr, $url, $targetFilename);
    }

    public function ResumeDownloadAsync($url, $targetFilename)
    {
    ...
    public function ResumeDownloadBd($url, $binData)
    {
        return CkHttp_ResumeDownloadBd($this->_cPtr, $url, $binData);
    }

    public function ResumeDownloadBdAsync($url, $binData)
    {
    ...
    public function S3_CreateBucket($bucketPath)
    {
        return CkHttp_S3_CreateBucket($this->_cPtr, $bucketPath);
    }

    public function S3_CreateBucketAsync($bucketPath)
    {
    ...
    public function S3_DeleteBucket($bucketPath)
    {
        return CkHttp_S3_DeleteBucket($this->_cPtr, $bucketPath);
    }

    public function S3_DeleteBucketAsync($bucketPath)
    {
    ...
    public function S3_DeleteMultipleObjects($bucketName, $objectNames)
    {
    ...
    public function S3_DeleteMultipleObjectsAsync($bucketName, $objectNames)
    {
    ...
    public function S3_DeleteObject($bucketPath, $objectName)
    {
        return CkHttp_S3_DeleteObject($this->_cPtr, $bucketPath, $objectName);
    }

    public function S3_DeleteObjectAsync($bucketPath, $objectName)
    {
    ...
    public function S3_DownloadBd($bucketPath, $objectName, $bd)
    {
        return CkHttp_S3_DownloadBd($this->_cPtr, $bucketPath, $objectName, $bd);
    }

    public function S3_DownloadBdAsync($bucketPath, $objectName, $bd)
    {
    ...
    public function S3_DownloadBytes($bucketPath, $objectName, $outBytes)
    {
        return CkHttp_S3_DownloadBytes($this->_cPtr, $bucketPath, $objectName, $outBytes);
    }

    public function S3_DownloadBytesAsync($bucketPath, $objectName)
    {
    ...
    public function S3_DownloadFile($bucketPath, $objectName, $localFilePath)
    {
        return CkHttp_S3_DownloadFile($this->_cPtr, $bucketPath, $objectName, $localFilePath);
    }

    public function S3_DownloadFileAsync($bucketPath, $objectName, $localFilePath)
    {
    ...
    public function s3_DownloadString($bucketPath, $objectName, $charset)
    {
        return CkHttp_s3_DownloadString($this->_cPtr, $bucketPath, $objectName, $charset);
    }

    public function S3_DownloadStringAsync($bucketPath, $objectName, $charset)
    {
    ...
    public function S3_FileExists($bucketPath, $objectName)
    {
        return CkHttp_S3_FileExists($this->_cPtr, $bucketPath, $objectName);
    }

    public function S3_FileExistsAsync($bucketPath, $objectName)
    {
    ...
    public function s3_GenerateUrl($bucket, $path, $expire)
    {
        return CkHttp_s3_GenerateUrl($this->_cPtr, $bucket, $path, $expire);
    }

    public function s3_GenerateUrlV4($useHttps, $bucketName, $path, $numSecondsValid, $awsService)
    {
        return CkHttp_s3_GenerateUrlV4($this->_cPtr, $useHttps, $bucketName, $path, $numSecondsValid, $awsService);
    }

    public function s3_GenPresignedUrl($httpVerb, $useHttps, $bucketName, $path, $numSecondsValid, $awsService)
    {
        return CkHttp_s3_GenPresignedUrl($this->_cPtr, $httpVerb, $useHttps, $bucketName, $path, $numSecondsValid, $awsService);
    }

    public function s3_ListBucketObjects($bucketPath)
    {
        return CkHttp_s3_ListBucketObjects($this->_cPtr, $bucketPath);
    }

    public function S3_ListBucketObjectsAsync($bucketPath)
    {
    ...
    public function s3_ListBuckets()
    {
        return CkHttp_s3_ListBuckets($this->_cPtr);
    }

    public function S3_ListBucketsAsync()
    {
    ...
    public function S3_UploadBd($bd, $contentType, $bucketPath, $objectName)
    {
        return CkHttp_S3_UploadBd($this->_cPtr, $bd, $contentType, $bucketPath, $objectName);
    }

    public function S3_UploadBdAsync($bd, $contentType, $bucketPath, $objectName)
    {
    ...
    public function S3_UploadBytes($contentBytes, $contentType, $bucketPath, $objectName)
    {
        return CkHttp_S3_UploadBytes($this->_cPtr, $contentBytes, $contentType, $bucketPath, $objectName);
    }

    public function S3_UploadBytesAsync($contentBytes, $contentType, $bucketPath, $objectName)
    {
    ...
    public function S3_UploadFile($localFilePath, $contentType, $bucketPath, $objectName)
    {
        return CkHttp_S3_UploadFile($this->_cPtr, $localFilePath, $contentType, $bucketPath, $objectName);
    }

    public function S3_UploadFileAsync($localFilePath, $contentType, $bucketPath, $objectName)
    {
    ...
    public function S3_UploadString($objectContent, $charset, $contentType, $bucketPath, $objectName)
    {
        return CkHttp_S3_UploadString($this->_cPtr, $objectContent, $charset, $contentType, $bucketPath, $objectName);
    }

    public function S3_UploadStringAsync($objectContent, $charset, $contentType, $bucketPath, $objectName)
    {
    ...
    public function SetAuthPrivateKey($publicKeyId, $privKey)
    {
        return CkHttp_SetAuthPrivateKey($this->_cPtr, $publicKeyId, $privKey);
    }

    public function SetCookieXml($domain, $cookieXml)
    {
        return CkHttp_SetCookieXml($this->_cPtr, $domain, $cookieXml);
    }

    public function SetOAuthRsaKey($privKey)
    {
    ...
    public function SetRequestHeader($headerFieldName, $headerFieldValue)
    {
    ...
    public function SetSslClientCertPem($pemDataOrPath, $pemPassword)
    {
        return CkHttp_SetSslClientCertPem($this->_cPtr, $pemDataOrPath, $pemPassword);
    }

    public function SetSslClientCertPfx($pfxPath, $pfxPassword)
    {
        return CkHttp_SetSslClientCertPfx($this->_cPtr, $pfxPath, $pfxPassword);
    }

    public function SetUrlVar($name, $value)
    {
        return CkHttp_SetUrlVar($this->_cPtr, $name, $value);
    }

    public function SharePointOnlineAuth($siteUrl, $username, $password, $extraInfo)
    {
        return CkHttp_SharePointOnlineAuth($this->_cPtr, $siteUrl, $username, $password, $extraInfo);
    }

    public function SharePointOnlineAuthAsync($siteUrl, $username, $password, $extraInfo)
    {
    ...
    public function SynchronousRequest($domain, $port, $ssl, $req)
    {
    ...
    public function SynchronousRequestAsync($domain, $port, $ssl, $req)
    {
    ...
    public function VerifyTimestampReply($timestampReply, $tsaCert)
    {
        return CkHttp_VerifyTimestampReply($this->_cPtr, $timestampReply, $tsaCert);
    }

    public function xmlRpc($urlEndpoint, $xmlIn)
    {
        return CkHttp_xmlRpc($this->_cPtr, $urlEndpoint, $xmlIn);
    }

    public function XmlRpcAsync($urlEndpoint, $xmlIn)
    {
    ...
    public function xmlRpcPut($urlEndpoint, $xmlIn)
    {
        return CkHttp_xmlRpcPut($this->_cPtr, $urlEndpoint, $xmlIn);
    }

    public function XmlRpcPutAsync($urlEndpoint, $xmlIn)
    {
