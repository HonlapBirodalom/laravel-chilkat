...
class CkAuthGoogle
{
    ...
    public function get_ExpireNumSeconds()
    {
        return CkAuthGoogle_get_ExpireNumSeconds($this->_cPtr);
    }

    public function put_ExpireNumSeconds($newVal)
    {
    ...
    public function put_Iat($newVal)
    {
        CkAuthGoogle_put_Iat($this->_cPtr, $newVal);
    }

    public function get_JsonKey($str)
    {
        CkAuthGoogle_get_JsonKey($this->_cPtr, $str);
    }

    public function jsonKey()
    {
        return CkAuthGoogle_jsonKey($this->_cPtr);
    }

    public function put_JsonKey($newVal)
    {
    ...
    public function get_SubEmailAddress($str)
    {
    ...
    public function put_SubEmailAddress($newVal)
    {
