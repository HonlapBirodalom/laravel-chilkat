...
class CkTrustedRoots
{
    ...
    public function get_RejectSelfSignedCerts()
    {
        return CkTrustedRoots_get_RejectSelfSignedCerts($this->_cPtr);
    }

    public function put_RejectSelfSignedCerts($newVal)
    {
        CkTrustedRoots_put_RejectSelfSignedCerts($this->_cPtr, $newVal);
    }

    public function get_TrustSystemCaRoots()
    {
        return CkTrustedRoots_get_TrustSystemCaRoots($this->_cPtr);
    }

    public function put_TrustSystemCaRoots($newVal)
    {
    ...
    public function AddJavaKeyStore($keystore)
    {
        return CkTrustedRoots_AddJavaKeyStore($this->_cPtr, $keystore);
    }

    public function AddJavaKeyStoreAsync($keystore)
    {
    ...
    public function LoadCaCertsPem($path)
    {
        return CkTrustedRoots_LoadCaCertsPem($this->_cPtr, $path);
    }

    public function LoadCaCertsPemAsync($path)
    {
